...
void ExtendedWorld::LoadContent() {
	...
	this->programID  = LoadShaders("E:\\GIT\\ProjectRED\\OpenGL_Portfolio_Project_Red\\example\\Shaders", "TransformVertexShadervertex.glsl", "ColorFragmentShader.glsl" );
	...
	this->MVP = glm::translate(MVP, glm::vec3(0.0f,1.0f,1.0f));
